...
const items = [
  {
    ...
    picture: 'https://aritzia.scene7.com/is/image/Aritzia/large/s23_04_a08_82022_15033_off_a.jpg',
    price: 49.99,
    size: 'S',
  ...
  },
  {
    ...
    picture: 'https://dks.scene7.com/is/image/GolfGalaxy/WL574ZSD_ShadowGrey_TOP?wid=2000&fmt=pjpeg',
    price: 79.99,
    size: '7.5',
  ...
  return (
    <View style={styles.container}>
      ...
      <Text></Text>
        ...
        <Text></Text>
        <Text style={styles.subheading}>My Recent Posts</Text>
        <Text></Text>
      {items.map(item => (
